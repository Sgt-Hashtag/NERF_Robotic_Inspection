...
package_name = "viethen_description"

def generate_launch_description():
    pkg_share = get_package_share_directory("viethen_description")
    default_model_path = os.path.join(pkg_share, "urdf/ur.urdf.xacro")
    default_rviz2_path = os.path.join(pkg_share, "rviz/simulation_viz.rviz")
